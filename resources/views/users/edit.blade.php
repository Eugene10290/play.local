                    ...
                    <div class="panel-body">
                        ...
                        @if (count($errors) > 0)
                            <div class="alert alert-danger">
                                <strong>Упс!!!</strong> Проблемы с вашим вводом : <br><br>
                                <ul>
                        ...
                        <form class="form-horizontal" role="form" method="POST"
                            ...
                            <div class="form-group{{ $errors->has('password_confirmation') ? ' has-error' : '' }}">
                                <label for="password_confirmation" class="col-md-4 control-label">Повторить пароль</label>
                            ...
                            <div class="form-group{{ $errors->has('roles') ? ' has-error' : '' }}">
                                <label for="roles" class="col-md-4 control-label">Роли(Одна или несколько)</label>
                                <div class="col-md-6">
