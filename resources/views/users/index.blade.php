            ...
            <div class="col-md-8 col-md-offset-2">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                            ...
                            @foreach ($users as $key => $user)
                                ...
                                <tr class="list-users">
                                    ...
                                    <td>
                                        ...
                                        <form action="{{ url('admin/users/'.$user->id) }}" method="POST" style="display: inline-block" onsubmit="return confirm('Вы действительно хотите удалить пользователя?')">
                                            {{ csrf_field() }}
                                            {{ method_field('DELETE') }}
                        ...
                        <a href="{{ route('users.create') }}" class="btn btn-success">Новый пользователь</a>
                    </div>
                </div>
            </div>
        </div>
